...
public class DialogIncluirTipoDeAtendimento extends JDialog {
	...
	private void initComponents(){
		...
		brIncluir.setIcon(new ImageIcon(DialogIncluirTipoDeAtendimento.class.getResource("/masterfila/desktop/view/img/ok.png")));
		
		btCancelar = new JButton("  Cancelar");
		btCancelar.setIcon(new ImageIcon(DialogIncluirTipoDeAtendimento.class.getResource("/masterfila/desktop/view/img/cancel.png")));
